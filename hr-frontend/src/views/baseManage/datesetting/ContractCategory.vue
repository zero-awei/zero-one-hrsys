<template>
  <el-container>
    ...
    ></el-main>
    <el-footer
      ><Pagination  :pageSizes="pageSizes" :total="tableData.length" handle></Pagination
    ></el-footer>
  </el-container>
</template>
...
// 定义表单数据
const xmlData = [
  { id: 1, name: '合同类别代码', prop: 'categoryCode' },
  { id: 2, name: '合同类别名称', prop: 'categoryName' }
]
// 注入表格数据
