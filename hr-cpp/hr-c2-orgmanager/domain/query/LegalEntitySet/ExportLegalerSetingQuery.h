...
#ifndef _EXPORTLEGALERSETTING_QUERY_
#define _EXPORTLEGALERSETTING_QUERY_
 ...
 * 示例分页查询对象
 */
class ExportLegalerSetingQuery : public PageQuery
{
	DTO_INIT(ExportLegalerSetingQuery, PageQuery);
	// 法人主体标识
...
#endif // !_EXPORTLEGALERSETTING_QUERY_