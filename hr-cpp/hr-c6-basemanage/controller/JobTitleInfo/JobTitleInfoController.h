...
public:
	...
	ENDPOINT_INFO(getJobTitle) {
		...
		info->queryParams["EMPLOYEEID"].addExample("default", String("192A0061"));
		...
		info->queryParams["EMPLOYEENAME"].addExample("default", String(""));
		...
		info->queryParams["PROFESSOR_DATE"].addExample("default", String(""));
		...
		info->queryParams["ORGANIZATION_NAME"].addExample("default", String(""));
		info->queryParams["ORGANIZATION_NAME"].required = false;
		info->queryParams.add<String>("PROFESSOR_GRADES").description = ZH_WORDS_GETTER("jobtitle.field.professor_grades");
		info->queryParams["PROFESSOR_GRADES"].addExample("default", String(""));
