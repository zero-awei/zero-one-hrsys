...
*/
#ifndef _ASSIGN_INFO_QUERY_DTO_
#define _ASSIGN_INFO_QUERY_DTO_
#include "../../GlobalInclude.h"

#include OATPP_CODEGEN_BEGIN(DTO)

class AssignInfoQueryDTO : public oatpp::DTO
{
	DTO_INIT(AssignInfoQueryDTO, DTO);
	//分配信息标识
 ...
 * 分页传输对象
 */
class AssignInfoPageDTO : public PageDTO<AssignInfoQueryDTO::Wrapper>
{
	DTO_INIT(AssignInfoPageDTO, PageDTO<AssignInfoQueryDTO::Wrapper>);
};

#include OATPP_CODEGEN_END(DTO)
#endif // !_ASSIGN_INFO_QUERY_DTO_