...
public:
	...
	ENDPOINT_INFO(queryAuditstatus) {
		...
		API_DEF_ADD_AUTH();
		// 定义响应参数格式
		API_DEF_ADD_RSP_JSON(AuditstatusPageJsonVO::Wrapper);
		// 定义分页参数描述
...
private:
	// 查询所有
	AuditstatusPageJsonVO::Wrapper executeQueryAuditstatus(const AuditstatusQuery::Wrapper& auditstatusQuery);
