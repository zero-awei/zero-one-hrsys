...
ArchivesListVO::Wrapper ArchivesLevelsController::execQueryArchivesLevels() {
	...
	auto upLevels = ArchivesLevelsDTO::createShared(u8"上层");
	auto midLevels = ArchivesLevelsDTO::createShared(u8"中层");
	auto downLevels = ArchivesLevelsDTO::createShared(u8"下层");
