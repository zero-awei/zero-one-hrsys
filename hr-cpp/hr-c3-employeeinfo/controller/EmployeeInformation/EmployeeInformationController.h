...
public: // 定义接口
	...
	//定义分页查询员工列表接口端点处理
	ENDPOINT(API_M_GET, "/employee-info/page-query", PageQueryInfo, API_HANDLER_AUTH_PARAME,QUERIES(QueryParams, queryParams)) {
		//解析查询参数（解析成领域模型对象）
	...
	//定义导入员工信息接口端点处理
	ENDPOINT(API_M_POST, "/employee-info/import-info", importEmployeeInfo, API_HANDLER_AUTH_PARAME, BODY_DTO(EmployeeInformationDTO::Wrapper, importInfo)) {
		// 响应结果
	...
	ENDPOINT(API_M_GET, "/employee-info/export-info", exportEmployeeInfo, API_HANDLER_AUTH_PARAME,QUERIES(QueryParams,queryParams)) {
		// 解析查询参数
	...
	//定义新增员工信息接口端点处理
	ENDPOINT(API_M_POST, "/employee-info/add-new-info", addEmployee, API_HANDLER_AUTH_PARAME, BODY_DTO(EmployeeInformationDTO::Wrapper, dto)) {
		// 响应结果
