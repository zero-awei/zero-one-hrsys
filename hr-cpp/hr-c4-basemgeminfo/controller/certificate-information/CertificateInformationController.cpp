...
CertificateInformationPageJsonVO::Wrapper CertificateInformationController::execQuerySample(const CertificateInformationQuery::Wrapper& query, const PayloadDTO& payload)
{
	// 定义一个Service
