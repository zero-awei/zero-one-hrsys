...
ArchivesPageDTO::Wrapper ArchivesService::listAll(const ArchivesQuery::Wrapper& query)
{
	...
	for (ArchivesDO sub : result)
	{
		...
		ZO_STAR_DOMAIN_DO_TO_DTO(dto, sub, name, Name, dabh, Dabh, ormorgid3, Ormorgid3, dabgd, Dabgd, archivescenterid, Archivescenterid, education, Education, dateofbirth, Dateofbirth, joinpartydate, Joinpartydate, startworkdatae, Startworkdatae, dazt, Dazt);
		pages->addData(dto);
