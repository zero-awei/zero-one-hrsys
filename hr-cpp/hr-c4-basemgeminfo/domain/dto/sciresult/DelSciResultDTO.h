...
*/
#ifndef _DELSCIRESULTDTO_
#define _DELSCIRESULTDTO_
...
class DelSciResultDTO : public oatpp::DTO
{
public:
	DelSciResultDTO() {};
	DTO_INIT(DelSciResultDTO, DTO);
	DTO_FIELD(List<String>, deleteById) = {};
	DTO_FIELD_INFO(deleteById) {
		info->description = ZH_WORDS_GETTER("sciresult.list<delSciResult>");
	}
