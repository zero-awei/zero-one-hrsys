...
*/
#ifndef _REWARDANDPUNISHMENTINFORMATIONDTO_H_
#define _REWARDANDPUNISHMENTINFORMATIONDTO_H_

#include "../../GlobalInclude.h"

#include OATPP_CODEGEN_BEGIN(DTO)

class RewardAndPunishmentInformationDTO : public oatpp::DTO
{
public:
	DTO_INIT(RewardAndPunishmentInformationDTO, DTO);
	//奖惩分类
	DTO_FIELD(String, lx);
	DTO_FIELD_INFO(lx) {
...
class RewardAndPunishmentInformationPageDTO : public PageDTO<RewardAndPunishmentInformationDTO::Wrapper>
{
	DTO_INIT(RewardAndPunishmentInformationPageDTO, PageDTO<RewardAndPunishmentInformationDTO::Wrapper>);
};

#include OATPP_CODEGEN_END(DTO)

#endif // !_REWARDANDPUNISHMENTINFORMATIONDTO_H_